...
<html lang="en" dir="ltr">
  <head>
    ...
    <!-- website title -->
    <title>West University | View/Modify Course Grades</title>
      ...
      <div class="first-container">
        <nav class="faculty-nav1">
          <ul>
            ...
            <li><a href="facultycoursemanagement.php">View Your Courses</a></li>
            <li><a href="facultycourseattendance.php">Course Attendance</a></li>
            <li><a href="facultycoursegrading.php" style="color:white;">Course Grading</a></li>
          </ul>
        </nav><br>
        <h1 style="font-size: 35px">View/Modify Grades</h1>
      </div>
      <div class="second-container">
        <div class="division2"></div> <br>
        <a href="facultycoursegrading.php"><h2 style="font-size: 15px;">Previous Page</h2></a> <br>
        ...
        <!-- Faculty member should be able to modify a grade if necessary as well. -->
        <!-- If student has no grade assigned yet, make N/A as default. -->
