...
<html lang="en" dir="ltr">
  <head>
    ...
    <!-- website title -->
    <title>West University | View/Modify Attendance</title>
      ...
      <div class="first-container">
        <nav class="faculty-nav1">
          <ul>
            ...
            <li><a href="facultycourseattendance.php" style="color:white;">Course Attendance</a></li>
            <li><a href="facultycoursegrading.php">Course Grading</a></li>
          </ul>
        </nav><br>
        <h1 style="font-size: 35px">View/Modify Attendance</h1>
      </div>
      <div class="second-container">
        <div class="division2"></div> <br>
        <a href="facultycourseattendance.php"><h2 style="font-size: 15px;">Previous Page</h2></a> <br>
        ...
        <!-- Each row has a number, which in this case is called Student# -->
        ...
        <table class="faculty-schedule-table">
          ...
          <tr>
            ...
            <td>Mathematics/Computer Science</td>
            <td style="background-color: green;">Present</td>
          </tr>
          <tr>
            <td>1</td>
            <td>700689555</td>
