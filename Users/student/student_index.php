...
?>
  ...
  <section class="whatweoffer bg-dark" style="margin: 0 auto; background: #000; color: #fff; ">


  <br>

<ul class="nav justify-content-center  bg-dark text-light"
  style="background-color: white; color : white; width: 50%; margin: 0 auto; border-radius: 20%;">
  <div style="text-align: center;">

    <li class="nav-item dropdown">
      <h1 class="h2">Welcome Student : <?php
    ...
    <div style="width: 50%; margin: 0 auto; border-radius: 5%; ">
      <h1 class="h2" tyle="text-align: center;">You are signed in.
    </div>
  </div>
